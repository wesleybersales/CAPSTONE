...
<head>
    ...
    <title>Register - Profit Lens System</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .alert-danger  { background: #fff5f5; color: #c62828; border: 1.5px solid #ffcdd2; }
        .alert-success { background: #f1f8e9; color: #2e7d32; border: 1.5px solid #c5e1a5; }
        ...
        .auth-field:nth-child(2) { animation-delay: 0.23s; }
        ...
        .auth-footer a:hover { color: #e53935; }
    </style>
</head>
<body>
        ...
        <form method="POST">
            ...
            <div class="auth-field">
                ...
                <div class="input-wrap">
                    ...
                    <svg class="field-icon" viewBox="0 0 24 24"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
                    <button type="button" class="eye-toggle" onclick="togglePwd(this)" aria-label="Toggle confirm password">
                        <svg viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                    </button>
                </div>
            </div>
    ...
    (function () {
        ...
        function heatmap(x, y, cols, rows, size){
            ctx.save();
        ...
        function draw(){
            ...
            candlestick(W/2-360, H-135, 145, 72);
